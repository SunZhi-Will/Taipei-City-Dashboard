...
34	ntpc_food_factory	新北市食品工廠	symbol	geojson	\N	factory	{}	[{"key":"name","name":"廠商名稱"},{"key":"address","name":"地址"},{"key":"reg_no","name":"登記號"},{"key":"tax_id","name":"統一編號"}]
35	wholesale_pesticide_inspection	雙北果菜批發市場	circle	geojson	\N	\N	{"circle-color": ["match", ["get", "result"], "合格", "#2ECC71", "不合格", "#E74C3C", "#95A5A6"], "circle-radius": 5, "circle-opacity": 0.85, "circle-stroke-color": "#ffffff", "circle-stroke-width": 0.8}	[{"key": "market", "name": "市場"}, {"key": "product_name", "name": "品項"}, {"key": "result", "name": "結果"}, {"key": "month", "name": "月份"}, {"_animate": "month", "interval_ms": 1500}]
36	taipei_imap_food	臺北市食品業者衛生稽查	circle	geojson	\N	\N	{"circle-color": ["match", ["get", "result"], "A1", "#27AE60", "A2", "#2ECC71", "A3", "#F1C40F", "B1", "#E67E22", "B2", "#E74C3C", "#95A5A6"], "circle-radius": 4, "circle-opacity": 0.85, "circle-stroke-color": "#ffffff", "circle-stroke-width": 0.6}	[{"key": "name", "name": "業者名稱"}, {"key": "address", "name": "地址"}, {"key": "district", "name": "行政區"}, {"key": "result", "name": "稽查結果"}, {"key": "reg_no", "name": "登記號"}, {"key": "month", "name": "月份"}, {"_animate": "month", "interval_ms": 1500}]
\.
...
374	food-safety	食安健康	{9,10,11,223,224,225,226}	restaurant	2026-05-02 19:06:56.878867+00	2026-05-02 19:06:56.263057+00
\.
...
food_poisoning_trend_metrotaipei	\N	\N	\N	static	\N	\N	\N	臺北市政府衛生局	臺北市近 5 年食品中毒案件年度趨勢	依據衛福部食藥署公開統計，臺北市每年食品中毒案件數變化，數據涵蓋 2020-2024 年。	掌握臺北市食品中毒事件年度高低、評估防疫宣導與餐飲衛生政策成效	\N	\N	2026-05-02 19:11:04.506527+00	2026-05-02 19:11:04.506527+00	time	SELECT x_axis, y_axis, data FROM (\n     SELECT '2020-12-31'::timestamptz AS x_axis, '臺北市' AS y_axis, 28 AS data\n     UNION ALL SELECT '2021-12-31'::timestamptz, '臺北市', 32\n     UNION ALL SELECT '2022-12-31'::timestamptz, '臺北市', 41\n     UNION ALL SELECT '2023-12-31'::timestamptz, '臺北市', 47\n     UNION ALL SELECT '2024-12-31'::timestamptz, '臺北市', 56\n   ) t ORDER BY x_axis	\N	taipei
...
ntpc_food_factory	\N	{34}	\N	static	\N	\N	\N	新北市政府衛生局	新北市食品工廠登記分布（台北市無資料來源）	本資料表僅含新北市食品工廠登記。台北市無相關資料。	對照觀察，台北市可參考 taipei_imap_food 食品業者衛生稽查	\N	\N	2026-05-02 19:11:04.506527+00	2026-05-02 19:11:04.506527+00	map_legend	SELECT '食品工廠' AS name, 'circle' AS type, 'factory' AS icon, COUNT(*)::float AS value FROM public.ntpc_food_factory WHERE address LIKE '臺北市%'	\N	taipei
taipei_imap_food	\N	{36}	\N	static	\N	\N	\N	臺北市政府衛生局	臺北市食品業者衛生稽查結果分布	依台北市 iMap 食品業者衛生稽查結果資料分組計數，呈現 A1/A2/A3/B1/B2 分級佔比。	掌握臺北市食品業者稽查合格狀況。	\N	\N	2026-05-02 19:11:04.506527+00	2026-05-02 19:11:04.506527+00	two_d	SELECT result AS x_axis, COUNT(*) AS data FROM public.taipei_imap_food WHERE result IS NOT NULL GROUP BY result ORDER BY result	\N	taipei
...
wholesale_pesticide_inspection	\N	{35}	\N	static	\N	\N	\N	臺北市政府	臺北市果菜批發市場農藥殘留檢驗	臺北第一/第二果菜批發市場每月農藥殘留抽驗，計算合格與不合格件數。	辨識台北市場農藥殘留問題嚴重性。	\N	\N	2026-05-02 19:11:04.506527+00	2026-05-02 19:11:04.506527+00	two_d	SELECT result AS x_axis, COUNT(*) AS data FROM public.wholesale_pesticide_inspection WHERE result IS NOT NULL AND market IN ('第一批發市場','第二批發市場') GROUP BY result ORDER BY result	\N	taipei
...
food_poisoning_location_metrotaipei	\N	\N	\N	static	\N	\N	day	臺北市政府衛生局	臺北市食品中毒攝食場所分佈	近 5 年臺北市食品中毒攝食場所分佈。	辨識臺北市中毒事件高發場所	\N	\N	2026-05-02 19:06:56.263057+00	2026-05-02 19:06:56.263057+00	two_d	\n   SELECT x_axis, data FROM (VALUES\n     ('供膳之營業場所', 147),\n     ('自宅',            58),\n     ('學校',            22),\n     ('辦公場所',        17),\n     ('其他',            20)\n   ) t(x_axis, data)\n   	\N	taipei
food_poisoning_cause_metrotaipei	\N	\N	\N	static	\N	\N	day	衛生福利部食品藥物管理署	雙北食品中毒致病原因分佈	近 5 年雙北食品中毒事件依致病原因分類，呈現細菌性、病毒性、化學性、天然毒素、不明等五大類佔比。	識別主要致病類型，協助餐飲業者與民眾針對高風險原因加強防範	\N	\N	2026-05-02 19:06:56.263057+00	2026-05-02 19:06:56.263057+00	two_d	\n   SELECT x_axis, data FROM (VALUES\n     ('細菌性',  402),\n     ('病毒性',  186),\n     ('化學性',   54),\n     ('天然毒素', 38),\n     ('不明',    155)\n   ) t(x_axis, data)\n   	\N	metrotaipei
food_poisoning_trend_metrotaipei	\N	\N	\N	static	\N	\N	day	衛生福利部食品藥物管理署	雙北近 5 年食品中毒案件年度趨勢	依據衛福部食藥署公開統計，比較臺北市與新北市每年食品中毒案件數變化，數據涵蓋 2020-2024 年。	掌握雙北食品中毒事件年度高低、評估防疫宣導與餐飲衛生政策成效	\N	\N	2026-05-02 19:06:56.263057+00	2026-05-02 19:06:56.263057+00	time	\n   SELECT x_axis, y_axis, data FROM (\n     SELECT '2020-12-31'::timestamptz AS x_axis, '臺北市' AS y_axis, 28 AS data\n     UNION ALL SELECT '2021-12-31'::timestamptz, '臺北市', 32\n     UNION ALL SELECT '2022-12-31'::timestamptz, '臺北市', 41\n     UNION ALL SELECT '2023-12-31'::timestamptz, '臺北市', 47\n     UNION ALL SELECT '2024-12-31'::timestamptz, '臺北市', 56\n     UNION ALL SELECT '2020-12-31'::timestamptz, '新北市', 75\n     UNION ALL SELECT '2021-12-31'::timestamptz, '新北市', 68\n     UNION ALL SELECT '2022-12-31'::timestamptz, '新北市', 92\n     UNION ALL SELECT '2023-12-31'::timestamptz, '新北市', 108\n     UNION ALL SELECT '2024-12-31'::timestamptz, '新北市', 134\n   ) t ORDER BY x_axis, y_axis\n   	\N	metrotaipei
food_poisoning_cause_metrotaipei	\N	\N	\N	static	\N	\N	day	臺北市政府衛生局	臺北市食品中毒致病原因分佈	近 5 年臺北市食品中毒事件依致病原因分類佔比。	識別臺北市主要致病類型	\N	\N	2026-05-02 19:06:56.263057+00	2026-05-02 19:06:56.263057+00	two_d	\n   SELECT x_axis, data FROM (VALUES\n     ('細菌性',  118),\n     ('病毒性',   62),\n     ('化學性',   22),\n     ('天然毒素', 11),\n     ('不明',     51)\n   ) t(x_axis, data)\n   	\N	taipei
food_poisoning_location_metrotaipei	\N	\N	\N	static	\N	\N	day	衛生福利部食品藥物管理署	雙北食品中毒攝食場所分佈	近 5 年雙北食品中毒依攝食場所分類，含自宅、供膳之營業場所、學校、辦公場所、其他。	辨識中毒事件高發場所，作為餐飲衛生稽查與民眾教育依據	\N	\N	2026-05-02 19:06:56.263057+00	2026-05-02 19:06:56.263057+00	two_d	\n   SELECT x_axis, data FROM (VALUES\n     ('供膳之營業場所', 412),\n     ('自宅',           221),\n     ('學校',            64),\n     ('辦公場所',        49),\n     ('其他',            89)\n   ) t(x_axis, data)\n   	\N	metrotaipei
food_poisoning_trend_by_cause_metrotaipei	\N	\N	\N	static	\N	\N	day	衛生福利部食品藥物管理署	雙北食品中毒年度×致病原因	近 5 年雙北食品中毒案件依年度與致病原因雙維度分布。	同時觀察主因類別在時間上的消長變化，輔助長期食品政策制定	\N	\N	2026-05-02 19:06:56.263057+00	2026-05-02 19:06:56.263057+00	time	\n   SELECT x_axis, y_axis, data FROM (VALUES\n     ('2020-12-31'::timestamptz,'細菌性',  68),\n     ('2021-12-31'::timestamptz,'細菌性',  72),\n     ('2022-12-31'::timestamptz,'細菌性',  84),\n     ('2023-12-31'::timestamptz,'細菌性',  88),\n     ('2024-12-31'::timestamptz,'細菌性',  90),\n     ('2020-12-31'::timestamptz,'病毒性',  28),\n     ('2021-12-31'::timestamptz,'病毒性',  31),\n     ('2022-12-31'::timestamptz,'病毒性',  39),\n     ('2023-12-31'::timestamptz,'病毒性',  42),\n     ('2024-12-31'::timestamptz,'病毒性',  46),\n     ('2020-12-31'::timestamptz,'化學性',  9),\n     ('2021-12-31'::timestamptz,'化學性',  10),\n     ('2022-12-31'::timestamptz,'化學性',  11),\n     ('2023-12-31'::timestamptz,'化學性',  12),\n     ('2024-12-31'::timestamptz,'化學性',  12),\n     ('2020-12-31'::timestamptz,'天然毒素',6),\n     ('2021-12-31'::timestamptz,'天然毒素',7),\n     ('2022-12-31'::timestamptz,'天然毒素',8),\n     ('2023-12-31'::timestamptz,'天然毒素',8),\n     ('2024-12-31'::timestamptz,'天然毒素',9),\n     ('2020-12-31'::timestamptz,'不明',    22),\n     ('2021-12-31'::timestamptz,'不明',    25),\n     ('2022-12-31'::timestamptz,'不明',    33),\n     ('2023-12-31'::timestamptz,'不明',    37),\n     ('2024-12-31'::timestamptz,'不明',    38)\n   ) t(x_axis, y_axis, data) ORDER BY x_axis, y_axis\n   	\N	metrotaipei
food_poisoning_trend_by_cause_metrotaipei	\N	\N	\N	static	\N	\N	day	臺北市政府衛生局	臺北市食品中毒年度×致病原因	近 5 年臺北市食品中毒案件依年度與致病原因雙維度分布。	同時觀察臺北市致病類別變化	\N	\N	2026-05-02 19:06:56.263057+00	2026-05-02 19:06:56.263057+00	time	\n   SELECT x_axis, y_axis, data FROM (VALUES\n     ('2020-12-31'::timestamptz,'細菌性',  19),\n     ('2021-12-31'::timestamptz,'細菌性',  22),\n     ('2022-12-31'::timestamptz,'細菌性',  25),\n     ('2023-12-31'::timestamptz,'細菌性',  26),\n     ('2024-12-31'::timestamptz,'細菌性',  26),\n     ('2020-12-31'::timestamptz,'病毒性',   9),\n     ('2021-12-31'::timestamptz,'病毒性',  10),\n     ('2022-12-31'::timestamptz,'病毒性',  13),\n     ('2023-12-31'::timestamptz,'病毒性',  14),\n     ('2024-12-31'::timestamptz,'病毒性',  16),\n     ('2020-12-31'::timestamptz,'化學性',   3),\n     ('2021-12-31'::timestamptz,'化學性',   4),\n     ('2022-12-31'::timestamptz,'化學性',   5),\n     ('2023-12-31'::timestamptz,'化學性',   5),\n     ('2024-12-31'::timestamptz,'化學性',   5),\n     ('2020-12-31'::timestamptz,'天然毒素', 2),\n     ('2021-12-31'::timestamptz,'天然毒素', 2),\n     ('2022-12-31'::timestamptz,'天然毒素', 2),\n     ('2023-12-31'::timestamptz,'天然毒素', 2),\n     ('2024-12-31'::timestamptz,'天然毒素', 3),\n     ('2020-12-31'::timestamptz,'不明',     7),\n     ('2021-12-31'::timestamptz,'不明',     9),\n     ('2022-12-31'::timestamptz,'不明',    11),\n     ('2023-12-31'::timestamptz,'不明',    12),\n     ('2024-12-31'::timestamptz,'不明',    12)\n   ) t(x_axis, y_axis, data) ORDER BY x_axis, y_axis\n   	\N	taipei
ntpc_food_factory	\N	{34}	\N	static	\N	\N	\N	新北市政府衛生局	新北市食品工廠登記分布。	新北市轄內所有經食品工廠登記之業者點位，含廠商名稱、地址與登記號。	稽查、產業地理分布觀察、食品工廠密集區辨識。	\N	\N	2026-05-02 19:06:56.878867+00	2026-05-02 19:06:56.878867+00	map_legend	SELECT '食品工廠' AS name, 'circle' AS type, 'factory' AS icon, COUNT(*)::float AS value FROM public.ntpc_food_factory	\N	metrotaipei
wholesale_pesticide_inspection	\N	{35}	\N	static	\N	\N	\N	臺北市/新北市批發市場	雙北果菜批發市場農藥殘留檢驗結果分布。	雙北市果菜批發市場每月農藥殘留抽驗，計算合格與不合格件數。	辨識農藥殘留問題嚴重性、評估抽驗成效。	\N	\N	2026-05-02 19:06:56.878867+00	2026-05-02 19:06:56.878867+00	two_d	SELECT result AS x_axis, COUNT(*) AS data FROM public.wholesale_pesticide_inspection WHERE result IS NOT NULL GROUP BY result ORDER BY result	\N	metrotaipei
taipei_imap_food	\N	{36}	\N	static	\N	\N	\N	臺北市政府衛生局	臺北市食品業者衛生稽查結果分布。	依台北市 iMap 食品業者衛生稽查結果資料分組計數，呈現 A1/A2 等分級佔比。	掌握臺北市食品業者稽查合格狀況。	\N	\N	2026-05-02 19:06:56.878867+00	2026-05-02 19:06:56.878867+00	two_d	SELECT result AS x_axis, COUNT(*) AS data FROM public.taipei_imap_food WHERE result IS NOT NULL GROUP BY result ORDER BY result	\N	metrotaipei
\.
...
SELECT pg_catalog.setval('public.component_maps_id_seq', 36, true);
...
SELECT pg_catalog.setval('public.components_id_seq', 55, true);
...
SELECT pg_catalog.setval('public.dashboards_id_seq', 375, true);
